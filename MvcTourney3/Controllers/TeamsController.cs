...
namespace MvcTourney3.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public TeamsController(MvcTourney3Context context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,GametitleId,School")] Team team)
        {
            if (id != team.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcTourney3Context.Team'  is null.");
            }
            var team = await _context.Team.FindAsync(id);
            if (team != null)
            {
